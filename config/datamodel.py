...
#   timestamp: 2025-10-08T23:00:11+00:00
...
class Agent(BaseModel):
    ...
    type: Type4 = Field(..., description="Type of agent")
...
class LlamaFarmConfig(BaseModel):
    ...
    agents: Optional[list[Agent]] = Field(None, description="List of agent configurations")
